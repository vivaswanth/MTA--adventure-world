<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete_log.aspx.cs" Inherits="delete_log" %>
  ...
  <div class="logout">
	...
	<div class="container-fluid">
		<div style="margin-top: 100px; margin-left: 50px; margin-right: 50px; height: 400px; color: white; background-color: rgba(34,34,34,0.6); " >
			<h1 style="padding: 30px 475px">DELETE LOGS</h1>
  			

  			<div class="insider">
  			<table style="margin-left:0px; width:100%; border: 2px solid white; padding:20px; ">
         <tr>
          <th>Aid</th>
          <th>Cid</th> 
          <th>Date</th>
