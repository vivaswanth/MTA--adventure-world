<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_remove.aspx.cs" Inherits="add_remove" %>
  ...
  <div class="logout">
	...
	<div class="container-fluid">
		<div style="margin-top: 100px; margin-left: 50px; margin-right: 50px; height: 400px; color: white; background-color: rgba(34,34,34,0.6); " >
			<h1 style="padding: 30px 390px">ADD/REMOVE FEATURES</h1>
  			<h3 style="margin-left: 300px">The Worlds most biggest Entertainment and Theme park...</h3> 		
          ...
          <input type="button" style="margin-left:500px; margin-top:20px; color:Black; background: #fff;border: 2px solid #fff;  cursor: pointer;
           ...
           height: 35px;background-color: #154360; color: white; opacity: 0.9; "onclick=" parent.location = 'add.aspx'"; value = "ADD FEATURES"; /><br>
          <input type="button" style="margin-left:500px; margin-top:20px; color:Black; background: #fff;border: 2px solid #fff;  cursor: pointer;
           border-radius: 2px; color: #a18d6c; font-family: 'Exo', sans-serif; font-size: 16px; font-weight: 400; padding: 6px; width: 250px;
           height: 35px;background-color: #154360; color: white; opacity: 0.9;"onclick=" parent.location = 'remove.aspx'"; value= "REMOVE FEATURES" /><br>
          <input type="button" style="margin-left:500px; margin-top:20px; color:Black; background: #fff;border: 2px solid #fff;  cursor: pointer;
           border-radius: 2px; color: #a18d6c; font-family: 'Exo', sans-serif; font-size: 16px; font-weight: 400; padding: 6px; width: 250px;
           height: 35px;background-color: #154360; color: white; opacity: 0.9;"onclick="parent.location = 'change.aspx' "; value= "CHANGE FARE" /><br>
  			</div>
		</div>
	</div>
</div>
