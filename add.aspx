...
<div id="home">
	<div class="container-fluid">
      ...
      <h1>Please provide the following details to Add a Category...</h1> 
      
      <form method="post">

      <div id="reg2">
        <ol>  
                <li><label for="cname">Category    :</label> <input id="" name="cname" required="required" type="text" placeholder="ex:waterworld"/></li>
                          
                <li><label for="sex">Feature       :</label> <input id="Text1" name="sex" required="required" type="text" placeholder="ex:wave pool"/></li>

                <li style="align-items: center;margin-top: 30px;position: relative;"><p class="signin button"> 
                    <asp:Button ID="Button1" runat="server" Text="Submit" OnClick="Button1_Click" cssclass="abb"/></p></li>         
                
                <li style="margin-top: -20px" id="check"><a href="adminpage.aspx">Back</a></p></li>  
              </ol>
