<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fare_calc.aspx.cs" Inherits="fare_calc" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Calculating fare...</title>
    <meta charset="utf-8">
  ...
  <div class="logout">
	...
	<div class="container-fluid">
		<div style="margin-top: 100px; margin-left: 50px; margin-right: 50px; height: 400px; color: white; background-color: rgba(34,34,34,0.6); " >
			<h1 style="padding: 30px 475px">Fare Calculation</h1>
  			<h3 style="margin-left: 300px"></h3> 		

  			<div class="insider">
         <label style="margin-left:400px; font-size:40px;">Total Fare:</label>
                  <asp:Button ID="Button1" runat="server" Text="Pay" OnClick="Button1_Click" cssclass="abc"/><br>
  			</div>
		</div>
	</div>
</div>
