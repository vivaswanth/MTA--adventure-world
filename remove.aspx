  ...
  <div class="logout">
	...
	<div class="container-fluid">
		<div style="margin-top: 100px; margin-left: 50px; margin-right: 50px; height: 400px; color: white; background-color: rgba(34,34,34,0.6); " >
			<h1 style="padding: 30px 450px">SPECIFY THE CATEGORY</h1>
  			<h3 style="margin-left: 300px"></h3> 		

  			<div class="insider">
  				
          <br>
          <label style="margin-left:200px; font-size:30px; margin-top:20px">Category: </label>
          <input type="text" style="height:50px; color: blue; font-size: 25px; " name="amount"><br><br>
                  <asp:Button ID="Button1" runat="server" Text="Proceed" OnClick="Button1_Click" CssClass="abc"  /> <br>
