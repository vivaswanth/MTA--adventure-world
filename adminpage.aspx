  ...
  <div class="logout">
	...
	<div class="container-fluid">
		<div style="margin-top: 100px; margin-left: 50px; margin-right: 50px; height: 400px; color: white; background-color: rgba(34,34,34,0.6); " >
			<h1 style="padding: 30px 350px; margin-left:130px">ADMIN PAGE</h1>
  			<h3 style="margin-left: 300px">The Worlds most biggest Entertainment and Theme park...</h3> 		

  			<div class="insider">
                  <asp:Button ID="Button1" runat="server" Text="Ticket Booked BY Customer" OnClick="Button1_Click"  CssClass="abc" /><br>
                  <asp:Button ID="Button2" runat="server" Text="Cancel Request" OnClick="Button2_Click" cssclass="abc"/><br>
                  <asp:Button ID="Button3" runat="server" Text="Delete Logs" OnClick="Button3_Click" cssclass="abc"/><br>
           ...
           height: 35px;background-color: #154360; color: white; opacity: 0.9;" onclick="parent.location = 'add_remove.aspx'" value= "Add/Remove Features" /><br>
