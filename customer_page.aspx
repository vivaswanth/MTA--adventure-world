<%@ Page Language="C#" AutoEventWireup="true" CodeFile="customer_page.aspx.cs" Inherits="customer_page" %>
  ...
  <div class="logout">
	...
	<div class="container-fluid">
		<div style="margin-top: 100px; margin-left: 50px; margin-right: 50px; height: 400px; color: white; background-color: rgba(34,34,34,0.6); " >
			<h1 style="padding: 30px 450px">CUSTOMER PAGE</h1>
           ...
           height: 35px;background-color: #154360; color: white; opacity: 0.9;" onclick="parent.location = 'ticket_booking.aspx'" value= "Book ticket" /><br>
                  <input type="button" style="margin-left:500px; margin-top:20px; color:Black; background: #fff;border: 2px solid #fff;  cursor: pointer;
           border-radius: 2px; color: #a18d6c; font-family: 'Exo', sans-serif; font-size: 16px; font-weight: 400; padding: 6px; width: 250px;
           height: 35px;background-color: #154360; color: white; opacity: 0.9;" onclick="parent.location = 'money.aspx'" value= "Add money to wallet" /><br>
                  <asp:Button ID="Button1" runat="server" Text="Cancel Tickets" OnClick="Button1_Click" cssclass="abc"/>  <br>
