<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ticket_booking.aspx.cs" Inherits="ticket_booking" %>
...
<div id="home">
	<div class="container-fluid">
		<div style="margin-top: 100px; margin-left: 50px; margin-right: 50px; height: 400px; color: white; background-color: rgba(34,34,34,0.6); " >
			<h1 style="padding: 30px 490px">Ticket Booking</h1>
  			<h3 style="margin-left: 300px"></h3> 		

  			<div class="insider">
          <label style="margin-left:430px;font-size:20px">Please Enter Number Of Days: </label>
          <input type="text" style="width: 100px;height:50px;color:blue; font-size:25px;" name="days"><br><br><br>
                  <asp:Button ID="Button1" runat="server" Text="Calculate Fare" OnClick="Button1_Click" CssClass="abc" /><br>
  			</div>
		</div>
	</div>
</div>
